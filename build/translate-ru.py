...
T = {
    ...
    "Failed to enable optimization.": "Не удалось включить оптимизацию.",
    "Welcome to OXPulse Imager": "Добро пожаловать в OXPulse Imager",
    "Skip for now": "Пропустить",
    "Welcome": "Добро пожаловать",
    "OXPulse Imager optimizes your images as WebP automatically — right on your server. No external service, no keys, no setup.": "OXPulse Imager автоматически оптимизирует изображения в WebP — прямо на вашем сервере. Никаких внешних сервисов, ключей и настроек.",
    "Ready — WebP supported": "Готово — WebP поддерживается",
    "Your server's image library can't produce WebP yet. Images are served unchanged until that's available — nothing else to do here.": "Библиотека изображений вашего сервера пока не умеет создавать WebP. Изображения отдаются без изменений, пока это не станет доступно — здесь больше ничего делать не нужно.",
    "WebP not available yet": "WebP пока недоступен",
    "Tuning": "Настройка",
    "Default quality 80 works for most sites.": "Качество 80 по умолчанию подходит для большинства сайтов.",
    "Fine-tune formats & per-format quality anytime in Settings → Format.": "Тонкая настройка форматов и качества по форматам — в любое время в Настройки → Формат.",
    "Unlock Pro": "Открыть Pro",
    "AVIF (~30% smaller than WebP)": "AVIF (~30% меньше, чем WebP)",
    "Self-hosted imgproxy delivery": "Доставка через self-hosted imgproxy",
    "<picture> element": "Элемент <picture>",
    "Cache control": "Управление кэшем",
    "Upgrade": "Обновить",
    "Available on Pro": "Доступно в Pro",
    "You're on Pro — configure AVIF & imgproxy in Settings → Connection": "У вас Pro — настройте AVIF и imgproxy в Настройки → Подключение",
    "Turn on optimization": "Включить оптимизацию",
